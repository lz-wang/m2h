...
普通 Markdown 表格渲染后表头可点击排序：第一次点击升序，再次点击降序，切换列后新列重新升序。排序自动识别文本、数字、日期、文件大小与点分版本号；表头支持键盘操作（Tab 聚焦后按 Enter 或 Space）。

| Project | Version | Size | Updated | Downloads |
| ------- | ------- | ---- | ------- | --------- |
| Alpha   | 1.10.0  | 12 MB | 2026-08-14 | 120 |
| Beta    | 1.2.0   | 850 KB | 2026-07-01 | 8 |
| Gamma   | 2.0.0   | 1.5 GB | 2026-08-01 | 42 |
